...
def set_loader(opt):
    if opt.dataset == 'waterbirds':
        ...
        train_loader = train_data.get_loader(train=True, reweight_groups=args.reweight_groups, \
                        batch_size=opt.batch_size, num_workers=opt.num_workers, pin_memory=True)
        val_loader = (val_data.get_loader(train=False, reweight_groups=None, \
                        batch_size=opt.batch_size, num_workers=opt.num_workers, pin_memory=True), \
                        test_data.get_loader(train=False, reweight_groups=None, \
                        batch_size=opt.batch_size, num_workers=opt.num_workers, pin_memory=True))
    else:
